...
// refer: https://stackoverflow.com/questions/70545129/compile-a-package-that-depends-on-esm-only-library-into-a-commonjs-package
async function getProvider(): Promise<any> {
  ...
  const {} = mod;
  console.log(mod.interactionPolicy)
  return mod;
}
let oidc;
getProvider().then(() => {
